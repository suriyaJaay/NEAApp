...
define(['app'], function (app) {
    ...
    var lD_injectParams = ['$q', '$compile'];
    var m_injectParams = ['$rootScope', 'modalService'];
    
    var linkDirective = function ($q, $compile) {
        return {
            restrict: 'A',
            scope: {
                linkDirective: '='
            ...
            compile: function compile(element) {
                return function (scope) {
                    if (scope && scope.linkDirective) { //secure?
                        element.attr('data-ui-sref-opts', '{reload: true}');
                    }
                }
            }
        }
    ...
    var bnModals = function ($rootScope, modals) {
    ...
    linkDirective.$inject = lD_injectParams;
    bnModals.$inject = m_injectParams;
    
    app.directive('linkDirective', linkDirective);
    app.directive('bnModals', bnModals);
});